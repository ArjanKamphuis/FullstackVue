<template>
    <div id="cart">
        ...
        <p v-else class="cart-empty-text has-text-centered">Add some items to the cart!</p>
        <button :disabled="!cartItems.length" class="button is-primary">Checkout (<span class="has-text-weight-bold">${{ cartTotal }}</span>)</button>
    </div>
</template>
