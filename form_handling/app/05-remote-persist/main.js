    ...
    template: `
        <div class="input-form">
            <form @submit="submitForm" class="ui form">
                ...
                <button v-else-if="saveStatus === 'SUCCESS'" :disabled="isNewItemInputLimitExceeded || isNotUrgent" class="ui button">Saved! Submit another</button>
                <button v-else-if="saveStatus === 'ERROR'" :disabled="isNewItemInputLimitExceeded || isNotUrgent" class="ui button">Save Failed - Retry?</button>
                <button v-else :disabled="isNewItemInputLimitExceeded || isNotUrgent" class="ui button">Submit</button>
            </form>
    ...
    methods: {
        submitForm(e) {
            ...
            apiClient.saveItems(items).then(() => {
                this.items = items;
                this.fields.newItem = this.fields.email = this.fields.urgency = '';
